    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.25rem' }}>
          <div style={{ fontSize: '1.05rem', color: '#2C2C2C', fontFamily: 'Cormorant Garamond, serif' }}>
            Reset Your Password
          </div>
          {resetInfo?.full_name && (
            <div style={{ fontSize: '0.85rem', color: '#7A7A7A', marginTop: '0.4rem' }}>
              Hi {resetInfo.full_name}, choose a new password below.
            </div>
          )}
        </div>
